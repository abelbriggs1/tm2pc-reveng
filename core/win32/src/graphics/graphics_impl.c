 ...
 */
static VOID ReleaseHalDevice (GraphicsContext* graphics)
{
 ...
 *
 */
static VOID CreateBackbufferSurface (GraphicsContext* graphics)
{
  HRESULT result;
  DWORD surface_caps;
 ...
 * @param[in,out]  graphics            Graphics context.
 */
static VOID CreatePrimaryAndMembufferSurfaces (GraphicsContext* graphics)
{
  HRESULT result;
 ...
 */
static HRESULT InitDirect3d (GraphicsContext* graphics)
{
...
{
  if (!graphics->ddraw2) {
    graphics->hwnd = TmWindowGetHwnd ();  // inlined
 ...
 */
HRESULT TmGraphicsRenderFrame (GraphicsContext* graphics)
{
